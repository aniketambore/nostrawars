...
class GameCursor extends StatelessWidget {
  const GameCursor({
    super.key,
    required this.child,
  });
  ...
  Widget build(BuildContext context) {
    return FancyCursor(
      color: white,
      size: 8,
      trailCustomCursor: Image.asset('assets/images/blue_cursor.png'),
      child: child,
    );
  }
}
...
class FancyCursor extends StatefulWidget {
  ...
  FancyCursor({
    ...
    this.trailCurve,
    this.trailOpacity,
    required this.trailCustomCursor,
    this.nativeCursor,
  }) : super(key: key) {
          ...
          children: [
            ...
            if (widget.trail != null)
              AnimatedPositioned(
                ...
                child: IgnorePointer(child: widget.trailCustomCursor
                    // ??
                    //     Container(
